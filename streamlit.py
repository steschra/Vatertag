...
st.set_page_config(page_title="Mehrnutzer Spielverwaltung", layout="wide")
st.title("Mehrnutzer Spielverwaltung")
...
if not st.session_state.spiel_started:
    ...
    spieler_input = st.text_area("Spieler (ein Name pro Zeile)")
    multi_input = st.text_input("Multiplikatoren pro Platz (z. B. 3,2,1)")
...
# SPIELBEREICH
    ...
    neue_runde = st.button("Neue Runde starten")
